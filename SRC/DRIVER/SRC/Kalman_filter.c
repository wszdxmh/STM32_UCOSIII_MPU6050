...
void Angle_Calcu(void)
{
	...
	else              x = 1 - (Accel_x - 32768) / 16384;//49152

	//处理y轴加速度
	if (Accel_y<32768) y = Accel_y / 16384;
	else              y = 1 - (Accel_y - 32768) / 16384;

	//处理z轴加速度
	if (Accel_z<32768) z = Accel_z / 16384;
	else              z = (Accel_z - 32768) / 16384;
	...
	//角度的正负号
	if (Angle_y_temp<32768) Angle_y_temp = +Angle_y_temp;
	if (Angle_y_temp>32768) Angle_y_temp = -Angle_y_temp;
	if (Angle_x_temp<32768) Angle_x_temp = +Angle_x_temp;
	if (Angle_x_temp>32768) Angle_x_temp = -Angle_x_temp;
	if (Angle_z_temp<32768) Angle_z_temp = +Angle_z_temp;
	if (Angle_z_temp>32768) Angle_z_temp = -Angle_z_temp;
